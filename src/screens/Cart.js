            ...
            <table className='table table-hover'>
                ...
                <tbody className='text-success '>
                    {data.map((food,index)=>(
                        ...
                        <td className='text-white' ><button type="button" className='btn p-0 '><img src={trash} alt='delete' onClick={()=>{dispatch({type:"REMOVE",index:index}) }} style={{ width: '15px', height: '15px' }}/></button></td>
